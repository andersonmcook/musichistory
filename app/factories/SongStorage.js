...
function($q, $http) {
  ...
  //           // song_list2 = Object.keys(objectFromJSONFile.songs).map(song => objectFromJSONFile.songs[song]);
  //           // song_list = song_list.concat(song_list2);
  //           song_list = Object.keys(objectFromJSONFile.songs).map(song => objectFromJSONFile.songs[song]);
  //           resolve(song_list);
  //         }, function(error) {
  //           reject(error);
  ...
  // var moreSongPromise = loadMoreSongs();
